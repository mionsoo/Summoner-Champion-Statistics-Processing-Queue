...
from helper.queries import (
    execute_summoner_insert_query,
    execute_summoner_match_insert_query,
    insert_summoner_champion_stats,
    update_summoner_matches, execute_select_inserted_match_id,
)
...
async def execute_update_queries_summoner_wait(conn, job_result: JobResult):
    ...
    changed_current_obj_status_code = job_result.processed_status
